...
import es.eucm.echaracter.main.Main;
...
public class eCharacter {
     ...
     * - listLanguage : List of available languages
     * - resolution : Gui resolution (width x height)
     * - assetsPath : Asset paths
     * - familiesPath: Families path
     * - localePath: Locale path
     * - defaultQualityFps: Default quality 
     * - defaultCameraName: Default camera name
     * - defaultVectorPosition: Default camera (Vector position)
     * - defaultVectorDirection: Default camera (Vector direction)
     * - defaultVectorUp: Default camera (Vector up)
