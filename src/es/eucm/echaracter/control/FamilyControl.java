...
import es.eucm.echaracter.data.family.AnimationStageType;
import es.eucm.echaracter.data.family.CameraType;
import es.eucm.echaracter.data.family.Family;
import es.eucm.echaracter.data.family.FpsType;
import es.eucm.echaracter.data.family.ModelRefType;
import es.eucm.echaracter.data.family.MultiStageType;
import es.eucm.echaracter.data.family.ScaleStageType;
import es.eucm.echaracter.data.family.ScaleStageType.BoneController;
