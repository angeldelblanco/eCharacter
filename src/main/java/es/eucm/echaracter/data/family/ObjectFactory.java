 ...
 * generated in the es.eucm.echaracter.data.family package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.eucm.echaracter.data.family
     * 
     */
